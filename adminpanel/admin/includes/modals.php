...
<!-- Modal For Add Category Exam -->
<div class="modal fade" id="modalForExamCat" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
   <form class="refreshFrm" id="addExamCatFrm" method="post" >
     <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body">
        <div class="col-md-12">
          ...
          <div class="form-group">
            ...
            <select class="form-control" name="examSelected">
              <option value="0">Select Exam</option>
              <?php 
                $selCourse = $conn->query("SELECT * FROM exam_tbl ORDER BY cou_id DESC");
                if($selCourse->rowCount() > 0)
                {
                  while ($selCourseRow = $selCourse->fetch(PDO::FETCH_ASSOC)) { ?>
        ...
        <div class="col-md-12">
          ...
          <div class="form-group">
            ...
            <select class="form-control" name="year_level" id="year_level">
              ...
              <option value="UBY_1">UPPER BASIC YEAR ONE</option>
              <option value="UBY_2">UPPER BASIC YEAR TWO</option>
              <option value="UBY_3">UPPER BASIC YEAR THREE</option>
              <option value="AY_1">ADVANCED YEAR ONE</option>
              <option value="AY_2">ADVANCED YEAR TWO</option>
              <option value="AY_3">ADVANCED YEAR THREE</option>
      ...
      <div class="modal-body">
        <div class="col-md-12">
          <div class="form-group">
            ...
            <input type="text" name="question" id="course_name" class="form-control" placeholder="Input question">
          </div>
          ...
          <div class="form-group">
            ...
            <select class="form-control" name="questionCategory" id="course">
              <option value="0">Select Category</option>
              <?php 
                $selCourse = $conn->query("SELECT * FROM exam_category_question_tbl WHERE course_id='$courseId' AND exam_id='$exId'");
                while ($selCourseRow = $selCourse->fetch(PDO::FETCH_ASSOC)) { ?>
                  <option value="<?php echo $selCourseRow['ID']; ?>"><?php echo $selCourseRow['title']; ?></option>
                <?php }
               ?>
            </select>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text," name="correctAnswer" id="" class="form-control" placeholder="Input correct answer" autocomplete="off">
            </div>
          </fieldset>
        </div>
      </div>
