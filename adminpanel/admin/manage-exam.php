                                               ...
                                               while ($selQuestionRow = $selQuest->fetch(PDO::FETCH_ASSOC)) { ?>
                                                <tr>
                                                        ...
                                                        <td class="text-center">
                                                         ...
                                                         <a rel="facebox" href="facebox_modal/updateQuestion.php?id=<?php echo $selQuestionRow['eqt_id']; ?>&course_id=<?php echo $courseId; ?>"" class="btn btn-sm btn-primary">Update</a>
